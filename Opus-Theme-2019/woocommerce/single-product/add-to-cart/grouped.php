...
<div class="grouped-product-shizzle">
	<form class="cart" method="post" enctype='multipart/form-data'>
				...
				<?php if ( !is_face_to_face($product) ) { ?>
				    <?php if ( $count > 1 ) echo ">" ?><div class="product-type cols-<?php echo $prod_types ?>">
				        <?php if ( is_e_learning($product) ) { ?>
        					...
        					<p>Simply select the number of e-learning licences you require and add to cart. We have amazing discounts for bulk purchases- see details below! Licences will be set up within a few hours.</p>
                        <?php } else { ?>
    					    <h4 style="clear:both;">Distance Learning</h4>
    					    <p class="product-medium">Self-Study Workbook</p>
        					<p>Simply select the number of workbook packs you require and purchase today. We have amazing discounts for bulk purchases- see details below!  Workbooks will be posted within 24 hours!</p>
                        <?php } ?>
				<?php } ?>
    	...
    	<p class="discounts-msg">All discounts for bulk purchases of e-learning or distance learning workbooks are added at checkout. There is a card handling fee for online purchases and VAT will be added where applicable. Please see our pricing information below to find out how you can save!</p>
	</form>
</div><!--rob-->
