...
function fw_show_hide_post_grid_view() {
    ...
    if( blog_view == '"grid"' ) {
        jQuery('#fw-backend-option-fw-option-posts_settings-grid_bg_color, #fw-backend-option-fw-option-posts_settings-masonry').show();
    }
    else {
        jQuery('#fw-backend-option-fw-option-posts_settings-grid_bg_color, #fw-backend-option-fw-option-posts_settings-masonry').hide();
    }
}
