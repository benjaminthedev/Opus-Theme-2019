...
$options = array(
	...
	'post_type' => array(
		'label'   => __( 'Post Type', 'the-core' ),
		'desc'    => __( 'Select the post type', 'the-core' ),
		'type'    => 'select',
		'value'   => '',
		'choices' => the_core_get_post_types(),
	),
	'columns_group' => array(
		'type'    => 'group',
		'options' => array(
			...
			'masonry' => array(
				...
				'value'        => 'on',
				'label'        => __( '', 'the-core' ),
				'desc'         => __( 'Enable masonry?', 'the-core' ),
				'left-choice'  => array(
					'value' => 'off',
	...
	'blog_title'              => array(
		...
		'picker'  => array(
			'selected' => array(
				...
				'desc'    => __( 'Choose the titles size, H1 being the largest', 'the-core' ),
				'value'   => 'h4',
				'choices' => array(
					'h1' => 'H1',
					'h2' => 'H2',
	...
	'description_advanced_styling' => array(
		...
		'desc'          => __( 'Change the style / typography for description', 'the-core' ),
		'button'        => __( 'Styling', 'the-core' ),
		'size'          => 'medium',
		'popup-options' => array(
			'description' => array(
