...
$section_style = $bg_image_set = $bg_video_data_attr = $extra_classes = $the_core_overlay_style = $custom_shape_top = $custom_shape_bottom = '';
...
if ( isset( $atts['margin_bottom'] ) && $atts['margin_bottom'] != '' && $atts['margin_bottom'] != 'fw-content-overlay-sm' && $atts['margin_bottom'] != 'fw-content-overlay-md' && $atts['margin_bottom'] != 'fw-content-overlay-lg' ) {
	$section_style .= 'margin-bottom:' . - (int) $atts['margin_bottom'] . 'px;';
...
if ( $atts['background_options']['background'] == 'image' && ! empty( $atts['background_options']['image']['background_image']['data'] ) ) {
	...
	$section_style .= ' background-image:url(' . the_core_url_without_protocol($atts['background_options']['image']['background_image']['data']['icon']) . ');';
	$section_style .= ' background-repeat: ' . $atts['background_options']['image']['repeat'] . ';';
	$section_style .= ' background-position: ' . $atts['background_options']['image']['bg_position_x'] . ' ' . $atts['background_options']['image']['bg_position_y'] . ';';
	$section_style .= ' background-size: ' . $atts['background_options']['image']['bg_size'] . ';';
	...
	if ( isset( $atts['background_options']['image']['background_color']['id'] ) && $atts['background_options']['image']['background_color']['id'] == 'fw-custom' && ! empty( $atts['background_options']['image']['background_color']['color'] ) ) {
		$section_style .= ' background-color:' . $atts['background_options']['image']['background_color']['color'] . ';';
	...
	if ( isset( $atts['background_options']['color']['background_color']['id'] ) && $atts['background_options']['color']['background_color']['id'] == 'fw-custom' ) {
		if ( ! empty( $atts['background_options']['color']['background_color']['color'] ) ) {
			$section_style .= ' background-color:' . $atts['background_options']['color']['background_color']['color'] . ';';
		}
...
if ( $atts['height'] != 'auto' && $atts['height'] != 'fw-section-height-sm' && $atts['height'] != 'fw-section-height-md' && $atts['height'] != 'fw-section-height-lg' ) {
	...
	$section_style .= ' height: ' . $height . 'px;';
...
// if is auto-generated no need this unique class
if ( isset( $atts['auto_generated'] ) && $atts['auto_generated'] != '1' && isset( $atts['unique_id'] ) ) {
...
// section id
$data_id = ( isset( $atts['link_id'] ) && ! empty( $atts['link_id'] ) ) ? 'id="' . $atts['link_id'] . '"' : '';

// section style (if is not empty concatenate with style tag)
if ( ! empty ( $section_style ) ) {
	$section_style = 'style="'.$section_style.'"';
}
?>
<section <?php echo ($data_parallax); ?> <?php echo ($data_id); ?> class="<?php echo esc_attr( trim( $extra_classes ) ); ?>" <?php echo ($bg_image_set); ?> <?php echo ($section_style); ?> <?php echo ($bg_video_data_attr); ?> >
