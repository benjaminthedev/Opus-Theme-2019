...
function the_core_theme_enqueue_styles() {
    wp_enqueue_style( 'parent-style', get_template_directory_uri() . '/style.css', array(), 'v202009171427' );
}
...
function add_my_scripts() {
    wp_enqueue_script( 'plusminus_v2', get_stylesheet_directory_uri() . '/js/plusminus_v2.js', array(), 'v202009211120', true );
