jQuery(document).ready(function ($) {
    ...
    $('a.fw-search-icon').click(function () {
        console.log('thish hdhidhiodhoeuhduohhdeuhdiehidhehdiuehi  ONEEEEE');
    });



    $(function () {
        console.log('thish hdhidhiodhoeuhduohhdeuhdiehidhehdiuehi');
    });
...
// const cartItems2 = document.querySelectorAll('.woocommerce-checkout-review-order .cart_item');

// if (cartItems2.length >= 2) {
//     console.log("Need to remove ");

//     const itemOnes = document.querySelector('.single_delegate_email');
//     console.log(itemOnes);
// }
